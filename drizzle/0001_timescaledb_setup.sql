-- TimescaleDB Hypertable Setup — Custom Migration
--
-- This file is NOT applied automatically by drizzle-kit migrate.
-- It is applied separately via:   npm run db:timescale
-- Or as part of full setup via:   npm run db:setup
--
-- Prerequisites:
--   1. PostgreSQL with TimescaleDB extension installed
--      (https://docs.timescale.com/install/latest/)
--   2. Set TIMESCALEDB_ENABLED=true in your .env.local
--   3. Run AFTER initial Drizzle migrations: npm run db:migrate
--
